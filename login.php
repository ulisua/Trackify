...
// Mostrar errores que vienen del callback
$errores = [
    'google_cancelado' => 'Cancelaste el inicio de sesión con Google.',
    'sin_codigo'       => 'No se recibió el código de Google.',
    'token_fallido'    => 'No se pudo obtener el token de Google.',
    'datos_google'     => 'No se pudieron obtener los datos de Google.',
];
...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    if($result->num_rows === 1){
        ...
        // Verificar que tenga clave (no es cuenta de Google puro)
        if(is_null($user['clave'])) {
            $mensaje = "Esta cuenta usa Google para iniciar sesión.";
...
<div class="auth-card">
    ...
    <a href="<?php echo $google_url; ?>" class="btn btn-google">
